...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=474485515ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=aa&table=b_home&lang=en">`aa`.`b_home`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=raxitgajera&table=auth_user&lang=en">`raxitgajera`.`auth_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vedansh&table=raxit_pages&lang=en">`vedansh`.`raxit_pages`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vedansh&table=raxit_contectusemail&lang=en">`vedansh`.`raxit_contectusemail`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vedansh&table=raxit_newproduct&lang=en">`vedansh`.`raxit_newproduct`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vedansh&table=auth_user&lang=en">`vedansh`.`auth_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vedansh&table=django_session&lang=en">`vedansh`.`django_session`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vedansh&table=django_migrations&lang=en">`vedansh`.`django_migrations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vedansh&table=auth_permission&lang=en">`vedansh`.`auth_permission`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vedansh&table=raxit_products&lang=en">`vedansh`.`raxit_products`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="6f414c70597b5f2d71566b6826697b45">
